...
- (void)btnClick:(UIButton *)btn
{
    ...
    view1 = [[XTPopView alloc] initWithOrigin:point Width:100 Height:40 * 4 Type:XTTypeOfUpRight Color:[UIColor colorWithRed:0.2737 green:0.2737 blue:0.2737 alpha:1.0]];
